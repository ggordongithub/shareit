...
class gsp_shareRef_locationcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(locationInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(locationInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:locationInstance, action:'save'])],2)
printHtmlPart(22)
})
