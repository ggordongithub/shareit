...
class gsp_shareRefemployeeProfile_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/employeeProfile.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(9)
invokeTag('render','g',114,['template':("/layouts/input/employee")],-1)
printHtmlPart(10)
invokeTag('message','g',128,['code':("spinner.alt"),'default':("Loading&hellip;")],-1)
printHtmlPart(11)
invokeTag('render','g',131,['template':("/layouts/home/footer")],-1)
printHtmlPart(12)
})
...
public static final long LAST_MODIFIED = 1418386200000L
