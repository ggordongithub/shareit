...
<g:form name='subEmprForm'
	...
	<div
		...
		<g:select name="yearsKnown"
			from="${['0-2 yrs', '3-5 yrs', '6-8 yrs', '9-11 yrs', '12-14 yrs', '15 plus yrs']}" required=""
			required="" value="${employeeExperienceInstance?.yearsKnown}"
			valueMessagePrefix="employeeExperience.yearsKnown" />

	</div>

    <div id="trait"><p>Choose no more than three character traits</p></div>
	...
	<div id="empExp"
		...
		<label for="experience"> <g:message
				code="employeeExperience.experience.label" default="Please describe projects results and/or your interactions with the employee/owner" />
		</label>
		<g:textArea rows="1" cols="1" name="experience" required="required data"
