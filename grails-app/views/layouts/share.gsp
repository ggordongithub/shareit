...
<body>
	...
	<div id="carousel">
		...
		<div id="slides">
			<ul>
				<li><asset:image src="slide1.gif" width="250" height="250"
					alt="Slide 1" /></li>
				<li><asset:image src="slide2.gif" width="250" height="250"
					alt="Slide 2" /></li>
				<li>
				<div id="user_input" style="width:300px; height:300;">
				<g:form >
                <fieldset class="form">
                    <div class="fieldcontain ${hasErrors(bean: endUserInstance, field: 'userName', 'error')} ">
                        <label for="userName">
                            <g:message code="endUser.userName.label" default="name" />
