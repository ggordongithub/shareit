		...
		<div id="list-location" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="zip" title="${message(code: 'location.zip.label', default: 'Zip')}" />
					
						<g:sortableColumn property="country" title="${message(code: 'location.country.label', default: 'Country')}" />
					
						<th><g:message code="location.employeeLocation.label" default="Employee Location" /></th>
				...
				<g:each in="${locationInstanceList}" status="i" var="locationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: locationInstance, field: "employeeLocation")}</td>
